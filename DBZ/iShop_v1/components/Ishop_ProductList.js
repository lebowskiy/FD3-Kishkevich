...
class IshopProductList extends React.PureComponent {
    ...
    deleteItem = (elem) => {
      let newArray = this.state.itemList.filter( (item) => {
          if(elem !== item.id) {
              return item;
          }
      });
...
export default IshopProductList;